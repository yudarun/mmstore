...
<script type="text/javascript">
    ...
    function one(pid, ispage) {
        ...
        var str  = "?pid="+pid+"&page="+ispage+"&pname"+pname+"&typeid="+typeid+"&iprice="+iprice+"&hprice="+hprice;
...
<script type="text/javascript">
    function ajaxsplit(page) {
        ...
        url:"${pageContext.request.contextPath}/prod/ajaxSplit.action",
            data:{"page":page,"pname":pname,"typeid":typeid,"iprice":iprice,"hprice":hprice},
            type:"post",
            success:function () {
                //重新加载分页显示的组件table
    ...
    function condition(){
        ...
        $.ajax({
            type:"post",
            url:"${pageContext.request.contextPath}/prod/ajaxSplit.action",
            data:{"pname":pname,"typeid":typeid,"iprice":iprice,"hprice":hprice},
           success:function (){
               $("#table").load("http://localhost:8080/mimiSSM/admin/product.jsp #table");
           }
        })
